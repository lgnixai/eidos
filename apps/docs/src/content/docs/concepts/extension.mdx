...
Eidos has two types of extensions: Script handles data logic, and Micro Block handles interface interactions.

<CardGrid>
  <LinkCard title="Script" href="/extensions/script"></LinkCard>
  <LinkCard title="Micro Block" href="/extensions/micro-block"></LinkCard>
</CardGrid>
