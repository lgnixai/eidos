...
const SelectTrigger = React.forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ React.createElement(
  ...
  children,
  /* @__PURE__ */ React.createElement(SelectPrimitive.Icon, { asChild: true }, /* @__PURE__ */ React.createElement(ChevronDownIcon, { className: "h-4 w-4 opacity-50" }))
));
...
const SelectScrollUpButton = React.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ React.createElement(
  ...
  /* @__PURE__ */ React.createElement(ChevronUpIcon, { className: "h-4 w-4" })
));
